...
static struct ov2722_control ov2722_controls[] = {
	{
		.qc = {
...
static int RG_Ratio_Typical  = 0x160;//fix me: copy from #1 malata board module
static int BG_Ratio_Typical = 0x194;
struct otp_struct {
...
static int ov2722_rear_camera_probe(struct i2c_client *client,
...
static struct i2c_driver ov2722_rear_camera_driver = {
	.driver = {
		.owner = THIS_MODULE,
		.name = OV2722_NAME,
	},
	.probe = ov2722_rear_camera_probe,
...
{
	return i2c_add_driver(&ov2722_rear_camera_driver);
}

static void exit_ov2722(void)
{
	i2c_del_driver(&ov2722_rear_camera_driver);
}
