...
#define FT5X06_RESET_PIN 60
#define FT5X06_INT_PIN   (130+12)

static struct i2c_board_info __initdata ft5x06_i2c_device = {
	I2C_BOARD_INFO("ft5x06", 0x38),
};

static struct ft5x06_platform_data ft5x06_platform_data = {
	.irq_pin = FT5X06_INT_PIN,
	.reset_pin = FT5X06_RESET_PIN,
	.x_max = 800,//modify by emdoor jim.kuang 2014-03-03
	.y_max = 1280,
};
...
static int __init ft5x06_i2c_init(void)
{
	...
	ft5x06_i2c_device.platform_data = &ft5x06_platform_data;

	return i2c_register_board_info(6, &ft5x06_i2c_device, 1);
}
