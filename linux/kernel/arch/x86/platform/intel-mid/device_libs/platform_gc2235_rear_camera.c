...
#include "platform_gc2235_rear_camera.h"
...
static int gc2235_rear_camera_gpio_ctrl(struct v4l2_subdev *sd, int flag)
{
	int ret;
	int pin;
...
static int gc2235_rear_camera_flisclk_ctrl(struct v4l2_subdev *sd, int flag)
{
 ...
 */
static int gc2235_rear_camera_power_ctrl(struct v4l2_subdev *sd, int flag)
{
	int ret = 0;
...
static int gc2235_rear_camera_csi_configure(struct v4l2_subdev *sd, int flag)
{
...
static struct camera_sensor_platform_data gc2235_sensor_rear_camera_platform_data = {
	.gpio_ctrl	= gc2235_rear_camera_gpio_ctrl,
	.flisclk_ctrl	= gc2235_rear_camera_flisclk_ctrl,
	.power_ctrl	= gc2235_rear_camera_power_ctrl,
	.csi_cfg	= gc2235_rear_camera_csi_configure,
};

void *gc2235_rear_camera_platform_data(void *info)
{
	gp_camera0_power_down = -1;
	gp_camera0_reset = -1;
	return &gc2235_sensor_rear_camera_platform_data;
}
