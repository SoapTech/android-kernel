...
static struct gc5004_reg const gc5004_720p_30fps[] = {
	//1936x1096
	{GC5004_8BIT, 0x18, 0x02},//skip off
	{GC5004_8BIT, 0x80, 0x10},//scaler off

	{GC5004_8BIT, 0x05, 0x01}, //HB
	{GC5004_8BIT, 0x06, 0x6e}, 
	{GC5004_8BIT, 0x09, 0x01},
	{GC5004_8BIT, 0x0a, 0xb0}, //row start
	{GC5004_8BIT, 0x0b, 0x01},
	{GC5004_8BIT, 0x0c, 0x10}, //col start
	{GC5004_8BIT, 0x0d, 0x04}, 
	{GC5004_8BIT, 0x0e, 0x48}, 
	{GC5004_8BIT, 0x0f, 0x07}, //Window setting
	{GC5004_8BIT, 0x10, 0xd0},  

	{GC5004_8BIT, 0x94, 0x4d},
	{GC5004_8BIT, 0x95, 0x04},
	{GC5004_8BIT, 0x96, 0x48},
	{GC5004_8BIT, 0x97, 0x07},
	{GC5004_8BIT, 0x98, 0x90},

	{GC5004_8BIT, 0xfe, 0x03},
	{GC5004_8BIT, 0x04, 0xe0},
	{GC5004_8BIT, 0x05, 0x01},
	{GC5004_8BIT, 0x12, 0x7e},
	{GC5004_8BIT, 0x13, 0x09},
	{GC5004_8BIT, 0x42, 0x90},
	{GC5004_8BIT, 0x43, 0x07},
...
static struct gc5004_reg const gc5004_2592x1944_30fps[] = {
	{GC5004_8BIT, 0x05, 0x01}, //HB
	{GC5004_8BIT, 0x06, 0x00}, 
	{GC5004_8BIT, 0x09, 0x00},
	{GC5004_8BIT, 0x0a, 0x02}, //row start
	{GC5004_8BIT, 0x0b, 0x00},
	{GC5004_8BIT, 0x0c, 0x00}, //col start
	{GC5004_8BIT, 0x0d, 0x07}, 
	{GC5004_8BIT, 0x0e, 0xa8}, 
	{GC5004_8BIT, 0x0f, 0x0a}, //Window setting
	{GC5004_8BIT, 0x10, 0x50},  

	{GC5004_8BIT, 0x94, 0x01},
	{GC5004_8BIT, 0x95, 0x07},
	{GC5004_8BIT, 0x96, 0x98},
	{GC5004_8BIT, 0x97, 0x0a},
	{GC5004_8BIT, 0x98, 0x20},

	{GC5004_8BIT, 0xfe, 0x03},
	{GC5004_8BIT, 0x04, 0x80},
	{GC5004_8BIT, 0x05, 0x02},
	{GC5004_8BIT, 0x12, 0xa8},
	{GC5004_8BIT, 0x13, 0x0c},
	{GC5004_8BIT, 0x42, 0x20},
...
/*	{
		...
		.regs = gc5004_720p_30fps,
		.width = 1932,
		.height = 1096,
				 .fps = 21,
				 .pixels_per_line = 0xe40,//fix me
				 .lines_per_frame = 0x480,//fix me
		.bin_factor_x = 1,
		.bin_factor_y = 1,
		.used = 0,
		.skip_frames = 2,
	},*/
	{
		...
		.height = 1944,
				 .fps = 12,
				 .pixels_per_line = 0xed8,
				 .lines_per_frame = 0x7d0,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
		.used = 0,
		.skip_frames = 2,
...
static struct gc5004_reg const gc5004_1280_30fps[] = {
	{GC5004_TOK_TERM, 0, 0},
};
...
struct gc5004_resolution gc5004_res_video[] = {
	{
		.desc = "gc5004_720p_dvs_30fps",
		.regs = gc5004_1280_30fps,
		.width = 1280,
		.height = 720,
				 .fps = 30,
				 .pixels_per_line = 0x11DC,
				 .lines_per_frame = 0x0B30,
		.bin_factor_x = 1,
		.bin_factor_y = 1,
		.used = 0,
		.skip_frames = 3,
...
struct gc5004_settings gc5004_sets[] = {
	//[GC5004_BAYTRAIL] = 
	{
		...
		.res_video = gc5004_res_preview, //gc5004_res_video,
		.n_res_preview = ARRAY_SIZE(gc5004_res_preview),
		.n_res_still = ARRAY_SIZE(gc5004_res_preview),//ARRAY_SIZE(gc5004_res_still),
		.n_res_video = ARRAY_SIZE(gc5004_res_preview),//ARRAY_SIZE(gc5004_res_video),
	},
};
