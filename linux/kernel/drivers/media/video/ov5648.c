			   ...
			   int irq, void *platform_data)
{
	...
	//Add by emdoor jim.kuang for register 0x35 
	client->addr=0x36;
			...
			const struct i2c_device_id *id)
{
	...
	//Add by emdoor jim.kuang 2014-05-06 for add 0v5648 Camera
	client->addr=0x36;//We register 0x35 ,here we change 0x35 to 0x36 address
	dev->fmt_idx = 0;
	//otp functions
