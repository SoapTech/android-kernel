		      ...
		      void			*param)
{
	...
	flag = DMA_PREP_INTERRUPT | DMA_CTRL_ACK;
// TODO ACPI
//	dev_dbg(drv_data->ssp_dev, "ssdr_addr = 0x%08x replaced by 0xFF2A1010\n",ssdr_addr);
//	ssdr_addr = 0xFF2A1010;
...
// TODO ACPI
//	dev_dbg(drv_data->ssp_dev, "ssdr_addr = 0x%08x replaced by 0xFF2A1010 for SSP1 only\n",ssdr_addr);
//	ssdr_addr = 0xFF2A1010;
...
EXPORT_SYMBOL_GPL(intel_mid_i2s_open_pci);
...
/*
	...
	if (chan->device->dev == drv_data->dmacdev)
		ret = true;
...
// TODO ACPI
//	dev_info(ddbg, " I2S SSSR=0x%08x SSSRMASKED=0x%08x MASK=0x%08x \n" , sssr, sssr_masked, drv_data->mask_sr);
...
//	isrx = LPE_ISRX_IAPIS_SSP2_MASK << (LPE_ISRX_IAPIS_SSP2_SHIFT
//					+ drv_data->device_instance);
// TODO ACPI BYT
	isrx = LPE_ISRX_IAPIS_SSP1_MASK << LPE_ISRX_IAPIS_SSP1_SHIFT;
...
//	TODO ACPI pci_dev_put(drv_data->dmac1);
