 ...
 *
 * $Id: wl_cfg80211.c 409184 2013-06-24 08:08:10Z $
 */
/* */
#include <typedefs.h>
#include <linuxver.h>
	...
	struct cfg80211_ap_settings *info)
{
	...
	kct_log(CT_EV_INFO, "cws.wifi", "hotspot_on", EV_FLAGS_PRIORITY_LOW,
		wlcfg_drv_priv->hostapd_ssid.SSID);
...
exit:
	kct_log(CT_EV_INFO, "cws.wifi", "hotspot_off", EV_FLAGS_PRIORITY_LOW, wl->hostapd_ssid.SSID);
	return err;
}
