...
#define GC2235_DRIVER	"gc223r"
#define GC2235_NAME	"gc223r"
...
static struct max_res gc2235_max_res[] = {
	[0] = {
...
static struct gc2235_resolution gc2235_res_video[] = {
	{
		.desc = "gc2235_720p_30fps",
		.regs = gc2235_720p_30fps,
		.width = 1296,
		.height = 736,
		.fps = 30,
		.pixels_per_line = 0x8c0,
...
static struct gc2235_settings gc2235_sets[] = {
	[0] = {
