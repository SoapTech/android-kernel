...
#define USI_MODEM_USBEN      	152      /* Customize by different HW layout and GPIO pin mapping */
...
#define USI_MODEM_DEVICE_FILE_NAME "/dev/ttyUSB1"
...
static int device_open(struct inode *inode, struct file *fp)
{
    ...
    dbg("usi_modem_ctrl: device_open()");
    Device_Open++;
 ...
 */
static int usi_modem_ioctrl_probe(struct platform_device *pdev)
{
    int grc, irq = 0;
    ...
    grc = gpio_export(USI_MODEM_USBEN, true);
    #endif
