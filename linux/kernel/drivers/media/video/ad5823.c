...
static int ad5823_set_arc_mode(struct i2c_client *client)
{
	...
	ret = ad5823_i2c_wr8(client, AD5823_CONTROL, AD5823_ARC_EN);
	if (ret)
		return ret;
	...
	ret = ad5823_i2c_wr8(client, AD5823_VCM_FREQ, AD5823_DEF_FREQ);
	return ret;
}
...
int ad5823_t_focus_vcm(struct v4l2_subdev *sd, u16 val)
{
	...
	return ad5823_i2c_wr16(client, AD5823_VCM_CODE_MSB, data);
}
...
int ad5823_t_focus_abs(struct v4l2_subdev *sd, s32 value)
{
	...
	u8 msb, lsb;
        ...
        ad5823_i2c_wr8(client, 0x04, msb);
        ad5823_i2c_wr8(client, 0x05, lsb);
#endif
