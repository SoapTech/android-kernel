...
static struct sfi_device_table_entry byt_ffrd10_devs_table[] = {
	...
	{SFI_DEV_TYPE_I2C, 3, 0x10, 0x0, 0x0, "ov5693"},
	{SFI_DEV_TYPE_I2C, 3, 0x3c, 0x0, 0x0, "gc223r"},
	{SFI_DEV_TYPE_I2C, 4, 0x3c, 0x0, 0x0, "gc2235"},
	#if 0
	{SFI_DEV_TYPE_I2C, 4, 0x36, 0x0, 0x0, "gc5004"},
	#endif	
	{SFI_DEV_TYPE_I2C, 3, 0x35, 0x0, 0x0, "ov5648"},//modify by emdoor jim.kuang change 0x36 to 0x35 for register rear camera
	{SFI_DEV_TYPE_I2C, 3, 0x36, 0x0, 0x0, "ov272r"},
	{SFI_DEV_TYPE_I2C, 4, 0x36, 0x0, 0x0, "ov2722"},
	{SFI_DEV_TYPE_I2C, 6, 0x38, 0x0, 0x0, "ft5x0x_ts"},
	//{SFI_DEV_TYPE_I2C, 4, 0x21, 0x0, 0x0, "gc0339"},
	{SFI_DEV_TYPE_I2C, 5, 0x0F, 0x0, 0x0, "kionix_accel"},//{SFI_DEV_TYPE_I2C, 5, 0x0F, 0x0, 0x0, "kionix_accel"},
