...
static int gc2235_set_suspend(struct v4l2_subdev *sd)
{
	...
	gc2235_write_reg(client, GCSENSOR_8BIT,  0x10, 0x80);//80///81///  84 
...
static int gc2235_set_streaming(struct v4l2_subdev *sd)
{
	...
	gc2235_write_reg(client, GCSENSOR_8BIT, 0xfe, 0x03);
	gc2235_write_reg(client, GCSENSOR_8BIT,  0x10, 0x90); //90 ///91// 94
	gc2235_write_reg(client, GCSENSOR_8BIT, 0xfe, 0x00);
	return 0;
}
...
static int gc2235_init_common(struct v4l2_subdev *sd)
{
	...
	int ret=0,count=0;
	ret=gc2235_write_reg(client, GCSENSOR_8BIT, 0xfe, 0x80);
	if(ret < 0)
		count ++;
	ret=gc2235_write_reg(client, GCSENSOR_8BIT, 0xfe, 0x80);
	if(ret < 0)
	...
	if(ret < 0)
		count ++;	
	ret=gc2235_write_reg(client, GCSENSOR_8BIT, 0xf6, 0x00);
	if(ret < 0)
		count ++;	
	...
	gc2235_write_reg(client, GCSENSOR_8BIT, 0xfa, 0x11);//base clkclk
	...
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x17, 0x15);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x18, 0x1a); //12
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x19, 0x0d);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x1a, 0x09); //01

	gc2235_write_reg(client, GCSENSOR_8BIT, 0x1b, 0x4d);////////////////////////
	...
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x40, 0x73);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x41, 0x84);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x43, 0x18);	
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x5e, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x5f, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x60, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x61, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x62, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x63, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x64, 0x18);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x65, 0x18);
	...
	gc2235_write_reg(client, GCSENSOR_8BIT, 0xfe, 0x03);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x01, 0x03);
	...
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x13, 0x06);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x15, 0x12);
	gc2235_write_reg(client, GCSENSOR_8BIT, 0x04, 0x01);
...
static struct gc2235_control gc2235_controls[] = {
	{
		.qc = {
...
static struct i2c_driver gc2235_driver = {
	...
	.probe = gc2235_probe,
	.remove = __devexit_p(gc2235_remove),
	.id_table = gc2235_ids,
};
