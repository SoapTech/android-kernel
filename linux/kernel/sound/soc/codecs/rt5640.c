...
/*#define USE_EQ*/
#define USE_ASRC
#define ONE_SPK     1  // default is 0 ,two SPKS
...
/*	{RT5640_ASRC_2		, 0xf800},*/
	...
	{RT5640_HP_VOL, 0x8484},	/*OUTMIX -> HPVOL */
...
/*	{RT5640_HP_CALIB_AMP_DET, 0x0420},*/
	...
	#ifdef ONE_SPK
	{RT5640_SPO_CLSD_RATIO, 0x0000},
	{RT5640_SPO_L_MIXER, 0xc800},	/*SPKVOLL -> SPOLMIX */
	#else
...
/*	{RT5640_I2S1_SDP	, 0xD000},//change IIS1 and IIS2*/
	/*record */
	{RT5640_IN1_IN2, 0x0080},	/*IN1 boost 20db and differential mode */
...
#endif
           #ifndef ONE_SPK
               snd_soc_write(codec, RT5640_DIG_INF_DATA, 0x0000);  //normal
            #endif
...
#endif
              snd_soc_write(codec, RT5640_DIG_INF_DATA, 0x4000);  // swap L.R
