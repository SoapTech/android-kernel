...
#include "device_libs/platform_gc2235_rear_camera.h"
#include "device_libs/platform_gc5004.h"
#include "device_libs/platform_ov2722_rear_camera.h"
...
extern void * kionix_platform_data(void *info);
#endif
...
struct devs_id __initconst device_ids[] = {
	...
	{"ov2722", SFI_DEV_TYPE_I2C, 0, &ov2722_platform_data,
					&intel_register_i2c_camera_device},
	{"ov272r", SFI_DEV_TYPE_I2C, 0, &ov2722_rear_camera_platform_data,
					&intel_register_i2c_camera_device},
	{"gc223r", SFI_DEV_TYPE_I2C, 0, &gc2235_rear_camera_platform_data,//add by emdoor jim.kuang 2014-03-10 for gc2235 back camera 
					&intel_register_i2c_camera_device},
	...
	//added by Justin.Zhao
	#ifdef CONFIG_INPUT_KIONIX_ACCEL
	{"kionix_accel", SFI_DEV_TYPE_I2C, 0, &kionix_platform_data, NULL},
	#endif
